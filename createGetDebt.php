            ...
            <div class="col-lg-12">
                ...
                <?php
                    if($_POST['usernameOwes'] && $_POST['amountOwes'] && $_POST['emailOwes']){
                        mysqli_query($db_conn,"insert into owe_Debt values('".$_SESSION['username']."','".$_POST['usernameOwes']."',".$_POST['amountOwes'].",default,'".$_POST['why']."');");
                        if(mysqli_error($db_conn)){
                            echo 'Something went wrong with the creation of the debt. Maybe you tried to trick the system';
                            exit();
                        }else{
                            $to = $_POST['emailOwes'];
                            $subject = "You owe ".$_SESSION['username'];

                            $message ="Hello ".$_POST['usernameOwes'].",\r\n\r\nYou owe me ".$_POST['amountOwes']."! For more details, please see http://hajkep.se/oweme \r\n\r\nRegards,\r\nThe OweMe Team and ".$_SESSION['username'];

                            $from = "From: OweMe <noreply@hajkep.se>";
                            
                            mail($to, $subject, $message, $from);

                            echo $_POST['usernameOwes'].' now owes you, '. $_SESSION['username']. ', '.$_POST['amountOwes'].' shiny coins. An email has been sent.';
                        }
                    }
                ?>
                </p>
